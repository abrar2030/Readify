...
public class CheckoutController {
    ...
    public CheckoutController(BillingService billingService, EmailService emailService, ShoppingCartService shoppingCartService) {
    ...
    public String placeOrder(@Valid Customer customer, BindingResult result, RedirectAttributes redirect) {
        ...
        this.emailService.sendEmail(customer.getEmail(), "bookstore - Order Confirmation", "Your order has been confirmed.");
        this.shoppingCartService.emptyCart();
        redirect.addFlashAttribute("successMessage", (Object)"The order is confirmed, check your email.");
        return "redirect:/cart";
    }
}
